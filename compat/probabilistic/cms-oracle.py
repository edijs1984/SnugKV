...
with socket.create_connection((HOST,PORT)) as s:
    ...
    run(s,"CMS.INITBYDIM","wrongdim","10","5")
    run(s,"CMS.MERGE","wrongdim","2","a","b")
    run(s,"CMS.INITBYDIM","neg","20","5")
    run(s,"CMS.INCRBY","neg","x","3")
    run(s,"CMS.INCRBY","neg","x","-2")
    run(s,"CMS.QUERY","neg","x")
    run(s,"CMS.INCRBY","neg","x","-2")
