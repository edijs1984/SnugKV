...
run FT.DROPINDEX products
run FT._LIST
 '{"category":"books","price":10,"title":"A","description":"Memory Guide"}'
...
run FT.DROPINDEX products
run FT._LIST
 '{"category":"games","price":20,"title":"B","description":"Game Server Design"}'
run JSON.SET product:3 '$' '{"category":"books","price":30,"title":"C"}'
run JSON.SET ignored:1 '$' '{"category":"books","price":15,"title":"ignored"}'
...
run FT.DROPINDEX products
run FT._LIST
 '{"category":"books","price":30,"title":"C","description":"Memory-Search Engine"}'
run JSON.SET ignored:1 '$' '{"category":"books","price":15,"title":"ignored"}'
...
run FT.DROPINDEX products
run FT._LIST
 '{"category":"books","price":15,"title":"ignored","description":"Memory Ignored"}'
